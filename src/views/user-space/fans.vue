<template>
  <div class="fans">
		<div class="info-empty" !v-if="!info.length">
			<div>
				<p v-if="actionName === 'fans'">还没有被关注哦！多发布菜谱，更容易被找到。</p>
				<p v-if="actionName === 'following'">还没有关注别人哦！可以预览菜谱，找到别人</p>
			</div>
		</div>
		<ul class="fans clearfix">
			...
			:to="{name:'space',query:{userId:item.userId}}"  tag="li" >
				...
				<div class="c">
					...
					<em class="info" v-if="activeName==='works'">
